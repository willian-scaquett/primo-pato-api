...
public enum TipoSuperPoder {
    //Blindemos o drone da água. Risco baixo, pois as teclogias para se blindar esquipamentos
    ...
    //Se não sabemos o tipo do poder dele, torcemos para nossa IA saber lidar minimamente com ele. Risco altíssimo,

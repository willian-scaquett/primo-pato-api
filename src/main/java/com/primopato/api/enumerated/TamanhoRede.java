...
public enum TamanhoRede {
    ...
    MEDIA("Média", new BigDecimal(200), 1001, 2000),
    GRANDE("Grande", new BigDecimal(300), 2001, 5000),
    EXTRA_GRANDE("Extra Grande", new BigDecimal(500), 5001, 10000),
    GIGANTE("Gigante", new BigDecimal(1000), 10001, Float.MAX_VALUE);
